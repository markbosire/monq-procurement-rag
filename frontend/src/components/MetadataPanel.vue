<script lang="ts">
/**
 * Document metadata display panel.
 *
 * Shows the document title, summary, and category-specific extracted
 * fields organised into themed section groups. Each field value can be
 * clicked to jump to its source location in the PDF.
 *
 * @displayName MetadataPanel
 * @version 1.0.0
 * @example
 * ```vue
 * <MetadataPanel
...
const props = defineProps<{
  ...
  /** Theme colour for the "View PDF" button. */
  themeColor: string
}>()
...
const emit = defineEmits<{
  ...
  (e: 'view-pdf'): void
  /** User clicked on an extracted field to jump to its source. */
